...
///
///</summary>
///<param name="This file contains inline asm code for retrieving "high">performance"</param>
///<param name="counters for x86 class CPUs.">counters for x86 class CPUs.</param>
///<param name=""></param>
///<param name="$Id: hwtime.h,v 1.3 2008/08/01 14:33:15 shane Exp $">$Id: hwtime.h,v 1.3 2008/08/01 14:33:15 shane Exp $</param>
///<param name=""></param>
///<param name=""></param>
