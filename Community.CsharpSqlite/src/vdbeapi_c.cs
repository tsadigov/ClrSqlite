...
return ( p == null || p.expired ) ? 1 : 0;
        ...
        ** pointer is a harmless no-op. */rc=SQLITE_OK;
			}
			else {
				Vdbe v=pStmt;
				sqlite3 db=v.db;
...
return sqlite3ValueText(pVal, SqliteEncoding.UTF16LE);
		...
		///
		///</summary>
		static void setResultStrOrError(sqlite3_context pCtx,/* Function context */string z,/* String pointer */int o,/* offset into string */int n,/* Bytes in string, or negative */SqliteEncoding enc,/* Encoding of z.  0 for BLOBs */dxDel xDel//void (*xDel)(void)     /* Destructor function */
		) {
			if(sqlite3VdbeMemSetStr(pCtx.s,z,o,n,enc,xDel)==SQLITE_TOOBIG) {
				sqlite3_result_error_toobig(pCtx);
			}
		}
		static void setResultStrOrError(sqlite3_context pCtx,/* Function context */string z,/* String pointer */int n,/* Bytes in string, or negative */SqliteEncoding enc,/* Encoding of z.  0 for BLOBs */dxDel xDel//void (*xDel)(void)     /* Destructor function */
		) {
...
//}
		...
		public static void sqlite3_result_text(sqlite3_context pCtx,string z,int o,//Offset
		int n,dxDel xDel) {
			Debug.Assert(sqlite3_mutex_held(pCtx.s.db.mutex));
...
sqlite3VdbeMemSetStr(pCtx.s, z, n, SqliteEncoding.UTF16LE, xDel);
		...
		public static void sqlite3_result_error_code(sqlite3_context pCtx,int errCode) {
			...
			if((pCtx.s.flags&MEM_Null)!=0) {
				setResultStrOrError(pCtx,sqlite3ErrStr(errCode),-1,SqliteEncoding.UTF8,SQLITE_STATIC);
			}
		}
		///<summary>
		...
		public static void sqlite3_result_error_toobig(sqlite3_context pCtx) {
			Debug.Assert(sqlite3_mutex_held(pCtx.s.db.mutex));
			pCtx.isError=SQLITE_ERROR;
			setResultStrOrError(pCtx,"string or blob too big",-1,SqliteEncoding.UTF8,SQLITE_STATIC);
		}
		///<summary>
...
return SQLITE_MISUSE_BKPT();
			...
			/* Check that malloc() has not failed. If it has, return early. */db=p.db;
...
*/if(rc!=SQLITE_ROW&&db.xProfile!=null&&0==db.init.busy&&p.zSql!=null) {
      ...
      */Debug.Assert(rc==SQLITE_ROW||rc==SQLITE_DONE||rc==SQLITE_ERROR||rc==SQLITE_BUSY||rc==SQLITE_MISUSE);
        ...
        */string zErr=sqlite3_value_text(db.pErr);
		...
		///
		///</summary>
		public static void sqlite3InvalidFunction(sqlite3_context context,/* The function calling context */int NotUsed,/* Number of arguments to the function */sqlite3_value[] NotUsed2/* Value of each argument */) {
...
return p.pMem.n;
        ...
        ** __attribute__((aligned(8))) macro.  *///    static const Mem nullMem 
    ...
    ** removal *////<summary>
        ...
        *///if ( db.mallocFailed != 0 )
		...
		public static string sqlite3_column_name(sqlite3_stmt pStmt,int N) {
			return columnName(pStmt,N,sqlite3_value_text,COLNAME_NAME);
		}
		#if !SQLITE_OMIT_UTF16
...
*/public static string sqlite3_column_decltype(sqlite3_stmt pStmt,int N) {
			return columnName(pStmt,N,sqlite3_value_text,COLNAME_DECLTYPE);
		}
		#if !SQLITE_OMIT_UTF16
...
pStmt, N, (const void*()(Mem))sqlite3_value_text16, COLNAME_COLUMN);
      ...
      */if(p.isPrepareV2&&((i<32&&p.expmask!=0&((u32)1<<i)!=0)||p.expmask==0xffffffff)) {
		...
		///
		///</summary>
		static int bindBlob(sqlite3_stmt pStmt,/* The statement to bind against */int i,/* Index of the parameter to bind */byte[] zData,/* Pointer to the data to be bound */int nData,/* Number of bytes of data to be bound */dxDel xDel,/* Destructor for the data */SqliteEncoding encoding/* Encoding for the data */) {
			Vdbe p=pStmt;
			Mem pVar;
			int rc;
			rc=vdbeUnbind(p,i);
		...
		///
		///</summary>
		public static int bindText(sqlite3_stmt pStmt,/* The statement to bind against */int i,/* Index of the parameter to bind */string zData,/* Pointer to the data to be bound */int nData,/* Number of bytes of data to be bound */dxDel xDel,/* Destructor for the data */SqliteEncoding encoding/* Encoding for the data */) {
			Vdbe p=pStmt;
			Mem pVar;
			int rc;
			rc=vdbeUnbind(p,i);
