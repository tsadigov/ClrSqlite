...
namespace Community.CsharpSqlite {
	...
	public partial class Sqlite3 {
		...
		public class PGroup {
			...
			/* MUTEX_STATIC_LRU or NULL */public int nMaxPage;
			/* Sum of nMax for purgeable caches */public int nMinPage;
			/* Sum of nMin for purgeable caches */public int mxPinned;
			/* nMaxpage + 10 - nMinPage */public int nCurrentPage;
			/* Number of purgeable pages allocated */public PgHdr1 pLruHead,pLruTail;
			/* LRU list of unpinned pages */// C#
			public PGroup() {
      ...
      */public PGroup pGroup;
			/* PGroup this cache belongs to */public int szPage;
			/* Size of allocated pages in bytes */public bool bPurgeable;
			/* True if cache is purgeable */public int nMin;
			/* Minimum number of pages reserved */public int nMax;
			/* Configured "cache_size" value */public int n90pct;
			/* nMax*9/10 *//* Hash table of all pages. The following variables may only be accessed
      ** when the accessor is holding the PGroup mutex.
      */public int nRecyclable;
			/* Number of pages in the LRU list */public int nPage;
			/* Total number of pages in apHash */public int nHash;
			/* Number of slots in apHash[] */public PgHdr1[] apHash;
			///<summary>
			///Hash table for fast lookup by key
			///</summary>
			public Pgno iMaxKey;
			/* Largest key seen since xTruncate() */public void Clear() {
				nRecyclable=0;
				nPage=0;
				nHash=0;
				apHash=null;
		...
		public class PgHdr1 {
			public Pgno iKey;
			/* Key value (page number) */public PgHdr1 pNext;
			/* Next in hash table chain */public PCache1 pCache;
			/* Cache that currently owns this page */public PgHdr1 pLruNext;
			/* Next in LRU list of unpinned pages */public PgHdr1 pLruPrev;
			///<summary>
			///Previous in LRU list of unpinned pages
			///</summary>
			// For C#
			public PgHdr pPgHdr=new PgHdr();
			/* Pointer to Actual Page Header */public void Clear() {
				this.iKey=0;
				this.pNext=null;
				this.pCache=null;
				this.pPgHdr.Clear();
		...
		public class PgFreeslot {
			...
			/* Next free slot */public PgHdr _PgHdr;
		/* Next Free Header */};
    ...
    */public class PCacheGlobal {
			public PGroup grp;
			/* The global PGroup for mode (2) *//* Variables related to SQLITE_CONFIG_PAGECACHE settings.  The
      ** szSlot, nSlot, pStart, pEnd, nReserve, and isInit values are all
      ** fixed at sqlite3_initialize() time and do not require mutex protection.
      ** The nFreeSlot and pFree values do require mutex protection.
      */public bool isInit;
			/* True if initialized */public int szSlot;
			/* Size of each free slot */public int nSlot;
			/* The number of pcache slots */public int nReserve;
			/* Try to keep nFreeSlot above this */public object pStart,pEnd;
			/* Bounds of pagecache malloc range *//* Above requires no mutex.  Use mutex below for variable that follow. */public sqlite3_mutex mutex;
			/* Mutex for accessing the following: */public int nFreeSlot;
			/* Number of unused pcache slots */public PgFreeslot pFree;
			/* Free page blocks *//* The following value requires a mutex to change.  We skip the mutex on
      ** reading because (1) most platforms read a 32-bit integer atomically and
      ** (2) even if an incorrect value is read, no great harm is done since this
      ** is really just an optimization. */public bool bUnderPressure;
			/* True if low on PAGECACHE memory */// C#
			public PCacheGlobal() {
				grp=new PGroup();
			}
		}
  ...
  if( p>=pcache1.pStart && p<pcache1.pEnd ){
    ...
    */static void pcache1TruncateUnsafe(PCache1 pCache,/* The cache to truncate */uint iLimit/* Drop pages with this pgno or larger */) {
		...
		static sqlite3_pcache pcache1Create(int szPage,bool bPurgeable) {
			PCache1 pCache;
			/* The newly created page cache */PGroup pGroup;
			/* The group the new page cache will belong to */int sz;
      ...
      */
		...
		static PgHdr pcache1Fetch(sqlite3_pcache p,Pgno iKey,int createFlag) {
			...
			/* Step 1: Search the hash table for an existing entry. */if(pCache.nHash>0) {
				int h=(int)(iKey%pCache.nHash);
				for(pPage=pCache.apHash[h];pPage!=null&&pPage.iKey!=iKey;pPage=pPage.pNext)
					;
			}
			/* Step 2: Abort if no existing page is found and createFlag is 0 */if(pPage!=null||createFlag==0) {
				pcache1PinPage(pPage);
				goto fetch_out;
			}
      ...
      */
			...
			pGroup=pCache.pGroup;
			#endif
			/* Step 3: Abort if createFlag is 1 but the cache is nearly full */nPinned=pCache.nPage-pCache.nRecyclable;
			...
			/* Step 4. Try to recycle a page. */if(pCache.bPurgeable&&pGroup.pLruTail!=null&&((pCache.nPage+1>=pCache.nMax)||pGroup.nCurrentPage>=pGroup.nMaxPage||pcache1UnderMemoryPressure(pCache))) {
				PCache1 pOtherCache;
      ...
      */Debug.Assert(pPage.pLruPrev==null&&pPage.pLruNext==null);
			...
			if(reuseUnlikely||pGroup.nCurrentPage>pGroup.nMaxPage) {
				...
				/* Add the page to the PGroup LRU list. */if(pGroup.pLruHead!=null) {
