...
namespace Community.CsharpSqlite {
    ...
    *///#include "sqliteInt.h"
		...
		public class sqlite3StatType {
			...
			/* Current value */public int[] mxValue=new int[10];
		/* Maximum value */}
...
// define wsdStat x[0]
    ...
    */static int sqlite3_db_status(sqlite3 db,/* The database connection whose status is desired */int op,/* Status verb */ref int pCurrent,/* Write current value here */ref int pHighwater,/* Write high-water mark here */int resetFlag/* Reset high-water mark if true */) {
			int rc=SQLITE_OK;
			/* Return code */sqlite3_mutex_enter(db.mutex);
			switch(op) {
        ...
        */case SQLITE_DBSTATUS_SCHEMA_USED: {
				int i;
				/* Used to iterate through schemas */int nByte=0;
				/* Used to accumulate return value */sqlite3BtreeEnterAll(db);
        ...
        */case SQLITE_DBSTATUS_STMT_USED: {
				Vdbe pVdbe;
				/* Used to iterate through VMs */int nByte=0;
				/* Used to accumulate return value *///db.pnBytesFreed = nByte;
