...
*///typedef u32 Pgno;
    ...
    *//* Open and close a Pager connection. *///int sqlite3PagerOpen(
	//  sqlite3_vfs*,
	//  Pager **ppPager,
	//  const char*,
	//  int,
	...
	/* Functions used to configure a Pager object. *///void sqlite3PagerSetBusyhandler(Pager*, int()(void ), object  );
	...
	/* Functions used to obtain and release page references. *///int sqlite3PagerAcquire(Pager *pPager, Pgno pgno, DbPage **ppPage, int clrFlag);
	//#define sqlite3PagerGet(A,B,C) sqlite3PagerAcquire(A,B,C,0)
	//DbPage *sqlite3PagerLookup(Pager *pPager, Pgno pgno);
	//void sqlite3PagerRef(DbPage);
	//void sqlite3PagerUnref(DbPage);
	/* Operations on page references. *///int sqlite3PagerWrite(DbPage);
	//void sqlite3PagerDontWrite(DbPage);
	//int sqlite3PagerMovepage(Pager*,DbPage*,Pgno,int);
	//int sqlite3PagerPageRefcount(DbPage);
	//void *sqlite3PagerGetData(DbPage );
	//void *sqlite3PagerGetExtra(DbPage );
	/* Functions used to manage pager transactions and savepoints. *///void sqlite3PagerPagecount(Pager*, int);
	...
	/* Functions used to query pager state and configuration. *///u8 sqlite3PagerIsreadonly(Pager);
	...
	/* Functions used to truncate the database file. *///void sqlite3PagerTruncateImage(Pager*,Pgno);
	//#if (SQLITE_HAS_CODEC) && !defined(SQLITE_OMIT_WAL)
	//void *sqlite3PagerCodec(DbPage );
	//#endif
	/* Functions to support testing and debugging. *///#if !NDEBUG || SQLITE_TEST
