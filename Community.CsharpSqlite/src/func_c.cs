...
namespace Community.CsharpSqlite {
	...
	public partial class Sqlite3 {
		...
		static void minmaxFunc(sqlite3_context context,int argc,sqlite3_value[] argv) {
			int i;
			int mask;
			/* 0 for min() or 0xffffffff for max() */int iBest;
			CollSeq pColl;
			Debug.Assert(argc>1);
    ...
    */static void substrFunc(sqlite3_context context,int argc,sqlite3_value[] argv) {
      ...
      */if(n==0&&r>=0&&r<IntegerExtensions.LARGEST_INT64-1) {
		...
		static void upperFunc(sqlite3_context context,int argc,sqlite3_value[] argv) {
			...
			/* Verify that the call to _bytes() does not invalidate the _text() pointer *///Debug.Assert( z2 == sqlite3_value_text( argv[0] ) );
			if(z2!=null) {
...
break;
    ...
    ** case.  Thus  'a' LIKE 'A' would be true. */static compareInfo likeInfoNorm=new compareInfo('%','_','\0',true);
		///<summary>
    ...
    */static bool patternCompare(string zPattern,/* The glob pattern */string zString,/* The string to compare against the glob */compareInfo pInfo,/* Information about how to do the compare */u32 esc/* The escape character */) {
			u32 c,c2;
			int invert;
			int seen;
			...
			/* True if the previous character was 'escape' */string inPattern=zPattern;
			//Entered Pattern
				...
				if(!prevEscape&&c==matchAll) {
					...
					if(c==0) {
						...
						if(c==esc) {
							...
							if(c==matchSet) {
								Debug.Assert(esc==0);
								/* This is GLOB, not LIKE */Debug.Assert(matchSet<0x80);
								/* '[' is a single-byte character */int len=0;
					...
					if(!prevEscape&&c==matchOne) {
						...
						if(c==matchSet) {
							u32 prior_c=0;
							Debug.Assert(esc==0);
							/* This only occurs for GLOB, not LIKE */seen=0;
							invert=0;
      ...
      */n=sqlite3_value_int(argv[0]);
		...
		static void quoteFunc(sqlite3_context context,int argc,sqlite3_value[] argv) {
			...
			case SQLITE_BLOB: {
				...
				/* No encoding change */zText=new StringBuilder(2*nBlob+4);
		...
		static void hexFunc(sqlite3_context context,int argc,sqlite3_value[] argv) {
			...
			/* No encoding change */StringBuilder zHex=new StringBuilder(n*2+1);
		...
		static void replaceFunc(sqlite3_context context,int argc,sqlite3_value[] argv) {
			string zStr;
			/* The input string A */string zPattern;
			/* The pattern string B */string zRep;
			/* The replacement string C */string zOut=null;
			/* The output */int nStr;
			/* Size of zStr */int nPattern;
			/* Size of zPattern */int nRep;
			/* Size of zRep */int nOut;
			/* Maximum size of zOut *///int loopLimit;    /* Last zStr[] that might match zPattern[] */
			int i,j=0;
			/* Loop counters */Debug.Assert(argc==3);
			UNUSED_PARAMETER(argc);
			...
			/* No encoding change */zPattern=sqlite3_value_text(argv[1]);
			if(zPattern==null) {
			...
			/* No encoding change */zRep=sqlite3_value_text(argv[2]);
			if(zRep==null)
				return;
    ...
    */static void trimFunc(sqlite3_context context,int argc,sqlite3_value[] argv) {
			string zIn;
			/* Input string */string zCharSet;
			/* Set of characters to trim */int nIn;
			/* Number of bytes in input */int izIn=0;
			/* C# string pointer */int flags;
			/* 1: trimleft  2: trimright  3: trim */int i;
			/* Loop counter */int[] aLen=null;
			/* Length of each character in zCharSet */byte[][] azChar=null;
			/* Individual characters in zCharSet */int nChar=0;
			/* Number of characters in zCharSet */byte[] zBytes=null;
			byte[] zBlob=null;
			if(sqlite3_value_type(argv[0])==SQLITE_NULL) {
				return;
			}
...
sqlite3_result_text(context, "?000", 4, SQLITE_STATIC);
		...
		public class SumCtx {
			public double rSum;
			/* Floating point sum */public i64 iSum;
			/* Integer sum */public i64 cnt;
			/* Number of elements summed */public int overflow;
			/* True if integer overflow seen */public bool approx;
			/* True if non-integer value was input to the sum */public Mem _M;
			public Mem Context {
				get {
					return _M;
				}
...
|| p.n == sqlite3_aggregate_count( context ) );
        ...
        */max=sqlite3_context_db_handle(context)!=null&&(int)sqlite3_user_data(context)!=0;
		...
		public struct sFuncs {
			...
			public sbyte nArg;
			public u8 argType;
			/* 1: 0, 2: 1, 3: 2,...  N:  N-1. */public u8 eTextRep;
			/* 1: UTF-16.  0: UTF-8 */public u8 needCollSeq;
			public dxFunc xFunc;
    ...
    */static void sqlite3RegisterGlobalFunctions() {
      ...
      */FuncDef[] aBuiltinFunc= {
				...
				/*  FUNCTION(coalesce,          -1, 0, 0, ifnullFunc       ), */// use versionFunc here just for a dummy placeholder
				new FuncDef(-1,SqliteEncoding.UTF8,SQLITE_FUNC_COALESCE,null,null,versionFunc,null,null,"coalesce",null,null),
				FUNCTION("hex",1,0,0,hexFunc),
				/*  FUNCTION(ifnull,             2, 0, 0, ifnullFunc       ), */// use versionFunc here just for a dummy placeholder
				...
				/*AGGREGATE("count",             0, 0, 0, countStep,       countFinalize  ), *//* AGGREGATE(count,             0, 0, 0, countStep,       countFinalize  ), */new FuncDef(0,SqliteEncoding.UTF8,SQLITE_FUNC_COUNT,null,null,null,countStep,countFinalize,"count",null,null),
