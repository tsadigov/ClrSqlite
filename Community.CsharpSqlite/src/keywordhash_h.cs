...
///INITIALLY
		...
		static TokenType innerKeywordCode (string z, int iOffset, int n)
		{
			int h, i;
			if (n < 2)
...
///</summary>
		...
		public static Engine.OpCode sqlite3KeywordCode (string z, int n)
		{
			return (Engine.OpCode)innerKeywordCode (z, 0, n);
		}
