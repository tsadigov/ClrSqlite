        ...
        public class DateUtils
        {
            ...
            static void computeJD(DateTime p)
            {
                ...
                else
                {
                    ...
                    ///<summary>
                    ///</summary>
                    ///<param name="If no YMD specified, assume 2000">01 </param>
            ...
            ///
            ///</summary>
            static int parseDateOrTime(sqlite3_context context, string zDate, ref DateTime p)
            {
                double r = 0.0;
                    ...
                    case 'u':
                        {
                            ...
                            {
                                p.iJD = (long)((p.iJD + 43200) / 86400 + 210866760000000L);
                    ...
                    case '9':
                        {
                            ...
                            if (z[n] == ':')
                            {
                                ...
                                ///<summary>
                                ///</summary>
                                ///<param name="A modifier of the form (+|">)HH:MM:SS.FFF adds (or subtracts) the</param>
                                ///<param name="specified number of hours, minutes, seconds, and fractional seconds">specified number of hours, minutes, seconds, and fractional seconds</param>
                                ///<param name="to the time.  The ".FFF" may be omitted.  The ":SS.FFF" may be">to the time.  The ".FFF" may be omitted.  The ":SS.FFF" may be</param>
                                ///<param name="omitted.">omitted.</param>
                                ///<param name=""></param>
            ...
            ///<summary>
            ///</summary>
            ///<param name="Process time function arguments.  argv[0] is a date">time stamp.</param>
            ///<param name="argv[1] and following are modifiers.  Parse them all and write">argv[1] and following are modifiers.  Parse them all and write</param>
            ///<param name="the resulting time into the DateTime structure p.  Return 0">the resulting time into the DateTime structure p.  Return 0</param>
            ///<param name="on success and 1 if there are any errors.">on success and 1 if there are any errors.</param>
            ///<param name=""></param>
            ///<param name="If there are zero parameters (if even argv[0] is undefined)">If there are zero parameters (if even argv[0] is undefined)</param>
            ///<param name="then assume a default value of "now" for argv[0].">then assume a default value of "now" for argv[0].</param>
            ///<param name=""></param>

            static int isDate(sqlite3_context context, int argc, sqlite3_value[] argv, ref DateTime p)
            {
                int i;
                string z;
