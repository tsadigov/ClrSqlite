...
///
///</summary>
///<param name="This file implements routines used to report what compile">time options</param>
///<param name="SQLite was built with.">SQLite was built with.</param>
///<param name=""></param>
///<param name="Included in SQLite3 port to C#">SQLite;  2008 Noah B Hart</param>
///<param name="C#">SQLite is an independent reimplementation of the SQLite software library</param>
///<param name=""></param>
///<param name="SQLITE_SOURCE_ID: 2011">28 17:03:50 ed759d5a9edb3bba5f48f243df47be29e3fe8cd7</param>
///<param name=""></param>
///<param name=""></param>
///<param name=""></param>
...
///<summary>
///</summary>
///<param name="Return the N">time option string.  If N is out of range,</param>
