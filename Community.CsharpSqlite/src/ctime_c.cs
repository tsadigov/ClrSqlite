...
** for those options in which the value is meaningful. *///#define CTIMEOPT_VAL_(opt) #opt
...
*/
      ...
      ** linear search is adequate.  No need for a binary search. */if(!String.IsNullOrEmpty(zOptName))
