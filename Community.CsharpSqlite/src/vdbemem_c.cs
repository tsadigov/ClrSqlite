...
return SQLITE_OK;
		...
		static void sqlite3VdbeMemReleaseExternal(Mem p) {
			...
			sqliteinth.testcase(p.flags&MEM_Agg);
			sqliteinth.testcase(p.flags&MEM_Dyn);
			sqliteinth.testcase(p.flags&MEM_RowSet);
			sqliteinth.testcase(p.flags&MEM_Frame);
...
return r;
		...
		///</summary>
		public static void sqlite3VdbeMemSetNull(Mem pMem) {
		...
		///</summary>
		///<param name="too large "> whose size exceeds p.db.aLimit[SQLITE_LIMIT_LENGTH].</param>
		///<param name=""></param>
...
*/
    static void sqlite3VdbeMemPrepareToChange( Vdbe pVdbe, Mem pMem )
    {
      ...
      pMem.pScopyFrom = null;
		...
		///
		///</summary>
		static int sqlite3VdbeMemSetBlob(Mem pMem,///
		///<summary>
		...
		///
		///</summary>
		static int sqlite3VdbeMemFromBtree(BtCursor pCur,///
		///<summary>
		...
		///
		///</summary>
		static int sqlite3ValueFromExpr(sqlite3 db,///
		///<summary>
		...
		///
		///</summary>
		static void sqlite3ValueSetStr(sqlite3_value v,///
		///<summary>
		///Value to be set 
		///</summary>
		int n,///
