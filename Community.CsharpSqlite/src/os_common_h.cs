...
///</summary>
///<param name="all of the platform">specific files (os_*.c) and is #included into those</param>
///<param name="files.">files.</param>
///<param name=""></param>
///<param name="This file should be #included by the os_*.c files only.  It is not a">This file should be #included by the os_*.c files only.  It is not a</param>
///<param name="general purpose header file.">general purpose header file.</param>
///<param name=""></param>
