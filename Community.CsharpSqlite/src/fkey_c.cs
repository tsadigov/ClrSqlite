...
namespace Community.CsharpSqlite
{
    public static class fkeyc
    {
        ...
        public static FKey sqlite3FkReferences(Table pTab)
        {
            ...
            return pTab.pSchema.ForeignKeys.Find(pTab.zName, nName, (FKey)null);
        }
        ///<summary>
        ...
        {   
            ...
            pTab.pFKey.linkedList()
            .ForEach(
                pFKey =>///Remove the FK from the fkeyHash hash table. 
                {
                    //if ( null == db || db.pnBytesFreed == 0 )
                    {
                        ...
                        else
                        {
                            ...
                            HashExtensions.Insert(pTab.pSchema.ForeignKeys, z, StringExtensions.Strlen30(z), p);
                        }
