...
*/case OP_Savepoint: {
      ...
      ** that the db->aVTrans[] array is empty.  */Debug.Assert(db.autoCommit==0||db.nVTrans==0);
          ...
          */case OP_SetCookie: {
					...
					/* See note about index shifting on OP_ReadCookie */rc=sqlite3BtreeUpdateMeta(pDb.pBt,pOp.p2,(u32)pIn3.u.i);
...
*/case OP_IntegrityCk: {
					...
					z=sqlite3BtreeIntegrityCheck(db.aDb[pOp.p5].pBt,aRoot,nRoot,(int)pnErr.u.i,ref nErr);
