...
namespace Community.CsharpSqlite {
    ...
    */static void sqlite3SelectDestInit(SelectDest pDest,SelectResultType eDest,int iParm) {
		...
		static Select sqlite3SelectNew(Parse pParse,/* Parsing context */ExprList pEList,/* which columns to include in the result */SrcList pSrc,/* the FROM clause -- which tables to scan */Expr pWhere,/* the WHERE clause */ExprList pGroupBy,/* the GROUP BY clause */Expr pHaving,/* the HAVING clause */ExprList pOrderBy,/* the ORDER BY clause */int isDistinct,/* true if the DISTINCT keyword is present */Expr pLimit,/* LIMIT value.  NULL means not used */Expr pOffset/* OFFSET value.  NULL means no offset */) {
			Select pNew;
			//           Select standin;
			...
			/* OFFSET implies LIMIT *///if( pNew==null   ){
			//  pNew = standin;
		...
		class Keyword {
			public u8 i;
			/* Beginning of keyword text in zKeyText[] */public u8 nChar;
			/* Length of the keyword in characters */public u8 code;
			/* Join type mask */public Keyword(u8 i,u8 nChar,u8 code) {
				this.i=i;
				this.nChar=nChar;
				this.code=code;
			}
		...
		static int sqlite3JoinType(Parse pParse,Token pA,Token pB,Token pC) {
			...
			Token p;
			/*   0123456789 123456789 123456789 123 */string zKeyText="naturaleftouterightfullinnercross";
		...
		///
		///</summary>
		static int tableAndColumnIndex(SrcList pSrc,/* Array of tables to search */int N,/* Number of tables in pSrc.a[] to search */string zCol,/* Name of the column we are looking for */ref int piTab,/* Write index of pSrc.a[] here */ref int piCol/* Write index of pSrc.a[*piTab].pTab.aCol[] here */) {
			int i;
			/* For looping over tables in pSrc */int iCol;
			/* Index of column matching zCol */Debug.Assert((piTab==0)==(piCol==0));
			/* Both or neither are NULL */for(i=0;i<N;i++) {
		...
		///
		///</summary>
		static void addWhereTerm(Parse pParse,/* Parsing context */SrcList pSrc,/* List of tables in FROM clause */int iLeft,/* Index of first table to join in pSrc */int iColLeft,/* Index of column in first table */int iRight,/* Index of second table in pSrc */int iColRight,/* Index of column in second table */int isOuterJoin,/* True if this is an OUTER join */ref Expr ppWhere/* IN/OUT: The WHERE clause to add to */) {
			sqlite3 db=pParse.db;
			Expr pE1;
			Expr pE2;
			Expr pEq;
		...
		static int sqliteProcessJoin(Parse pParse,Select p) {
			SrcList pSrc;
			/* All tables in the FROM clause */int i;
			int j;
			/* Loop counters */SrcList_item pLeft;
			/* Left table being joined */SrcList_item pRight;
			/* Right table being joined */pSrc=p.pSrc;
			//pLeft = pSrc.a[0];
			//pRight = pLeft[1];
        ...
        */if((pRight.jointype&JT_NATURAL)!=0) {
					...
					for(j=0;j<pRightTab.nCol;j++) {
						string zName;
						/* Name of column in the right table */int iLeft=0;
						/* Matching left table */int iLeftCol=0;
						/* Matching column in the left table */zName=pRightTab.aCol[j].zName;
        ...
        */if(pRight.pUsing!=null) {
					...
					for(j=0;j<pList.nId;j++) {
						string zName;
						/* Name of the term in the USING clause */int iLeft=0;
						/* Table on the left with matching column name */int iLeftCol=0;
						/* Column number of matching column on the left */int iRightCol;
						/* Column number of matching column on the right */zName=pList.a[j].zName;
		...
		///
		///</summary>
		static void pushOntoSorter(Parse pParse,/* Parser context */ExprList pOrderBy,/* The ORDER BY clause */Select pSelect,/* The whole SELECT statement */int regData/* Register holding data to be sorted */) {
			Vdbe v=pParse.pVdbe;
		...
		///
		///</summary>
		static void codeOffset(Vdbe v,/* Generate code into this VM */Select p,/* The SELECT statement being coded */int iContinue/* Jump here to skip the current record */) {
		...
		///
		///</summary>
		static void codeDistinct(Parse pParse,/* Parsing and code generating context */int iTab,/* A sorting index used to test for distinctness */int addrRepeat,/* Jump to here if not distinct */int N,/* Number of elements */int iMem/* First element */) {
			Vdbe v;
			int r1;
			v=pParse.pVdbe;
		...
		///</summary>
		static bool checkForMultiColumnSelectError(Parse pParse,/* Parse context. */SelectDest pDest,/* Destination of SELECT results */int nExpr/* Number of result columns returned by SELECT */) {
		...
		///</summary>
		static void selectInnerLoop(Parse pParse,/* The parser context */Select p,/* The complete select statement being coded */ExprList pEList,/* List of values being extracted */int srcTab,/* Pull data from this table */int nColumn,/* Number of columns in the source table */ExprList pOrderBy,/* If not NULL, sort results using this key */int distinct,/* If >=0, make sure results are distinct */SelectDest pDest,/* How to dispose of the results */int iContinue,/* Jump here to continue with next row */int iBreak/* Jump here to break out of the inner loop */) {
			Vdbe v=pParse.pVdbe;
			int i;
			bool hasDistinct;
			/* True if the DISTINCT keyword is present */int regResult;
			/* Start of memory holding result set */SelectResultType eDest=pDest.eDest;
			/* How to dispose of results */int iParm=pDest.iParm;
			/* First argument to disposal method */int nResultCol;
			/* Number of result columns */Debug.Assert(v!=null);
			if(NEVER(v==null))
				return;
...
*/case SelectResultType.Set: {
              ...
              ** case the order does matter */pushOntoSorter(pParse,pOrderBy,p,regResult);
				}
				else {
					int r1=sqlite3GetTempReg(pParse);
        ...
        */case SelectResultType.Exists: {
				...
				/* The LIMIT clause will terminate the loop for us */break;
			}
...
static void explainSetInteger(ref int a, int b){ a = b;}
		...
		///
		///</summary>
		static void explainComposite(Parse pParse,/* Parse context */int op,/* One of TK_UNION, TK_EXCEPT etc. */int iSub1,/* Subquery id 1 */int iSub2,/* Subquery id 2 */bool bUseTmp/* True if a temp table was used */) {
...
static void explainComposite(Parse v, int w,int x,int y,bool z) {}
		...
		///</summary>
		static void generateSortTail(Parse pParse,/* Parsing context */Select p,/* The SELECT statement */Vdbe v,/* Generate code into this VDBE */int nColumn,/* Number of columns of data */SelectDest pDest/* Write the sorted results here */) {
			int addrBreak=sqlite3VdbeMakeLabel(v);
			/* Jump here to exit loop */int addrContinue=sqlite3VdbeMakeLabel(v);
			/* Jump here for next cycle */int addr;
			int iTab;
			int pseudoTab=0;
      ...
      */sqlite3VdbeResolveLabel(v,addrContinue);
		...
		static string columnType(NameContext pNC,Expr pExpr,ref string pzOriginDb,ref string pzOriginTab,ref string pzOriginCol) {
            ...
            */Table pTab=null;
				/* Table structure column is extracted from */Select pS=null;
				/* Select the column is extracted from */int iCol=pExpr.iColumn;
				/* Index of column in pTab */testcase(pExpr.op==TK_AGG_COLUMN);
              ...
              */if(iCol>=0&&ALWAYS(iCol<pS.pEList.nExpr)) {
                ...
                */NameContext sNC=new NameContext();
					...
					if(ALWAYS(pTab.pSchema)) {
						/* A real table */Debug.Assert(pS==null);
						if(iCol<0)
							iCol=pTab.iPKey;
		...
		///
		///</summary>
		static void generateColumnTypes(Parse pParse,/* Parser context */SrcList pTabList,/* List of tables */ExprList pEList/* Expressions defining the result set */) {
        ...
        */
		...
		static void generateColumnNames(Parse pParse,/* Parser context */SrcList pTabList,/* List of tables */ExprList pEList/* Expressions defining the result set */) {
			...
			bool shortNames;
			#if !SQLITE_OMIT_EXPLAIN
			/* If this is an EXPLAIN, skip this step */if(pParse.explain!=0) {
				return;
			}
			#endif
				...
				if(pEList.a[i].zName!=null) {
					...
					if((p.op==TK_COLUMN||p.op==TK_AGG_COLUMN)&&pTabList!=null) {
						...
						if(!shortNames&&!fullNames) {
							sqlite3VdbeSetColName(v,i,COLNAME_NAME,pEList.a[i].zSpan,SQLITE_DYNAMIC);
		...
		///
		///</summary>
		static int selectColumnsFromExprList(Parse pParse,/* Parsing context */ExprList pEList,/* Expr list from which to derive column names */ref int pnCol,/* Write the number of columns here */ref Column[] paCol/* Write the new column list here */) {
			sqlite3 db=pParse.db;
			/* Database connection */int i,j;
			/* Loop counters */int cnt;
			/* Index added to make the name unique */Column[] aCol;
			Column pCol;
			/* For looping over result columns */int nCol;
			/* Number of columns in the result set */Expr p;
			/* Expression for a single result column */string zName;
			/* Column name */int nName;
			/* Size of name in zName[] */pnCol=nCol=pEList.nExpr;
        ...
        */p=pEList.a[i].pExpr;
				Debug.Assert(p.pRight==null||ExprHasProperty(p.pRight,EP_IntValue)||p.pRight.u.zToken==null||p.pRight.u.zToken.Length>0);
				if(pEList.a[i].zName!=null&&(zName=pEList.a[i].zName)!="") {
					/* If the column contains an "AS <name>" phrase, use <name> as the name *///zName = sqlite3DbStrDup(db, zName);
				}
				else {
					Expr pColExpr=p;
					/* The expression that is the result column name */Table pTab;
					/* Table associated with this expression */while(pColExpr.op==TK_DOT)
						pColExpr=pColExpr.pRight;
					if(pColExpr.op==TK_COLUMN&&ALWAYS(pColExpr.pTab!=null)) {
						/* For columns use the column name name */int iCol=pColExpr.iColumn;
						pTab=pColExpr.pTab;
						if(iCol<0)
							iCol=pTab.iPKey;
						...
						if(pColExpr.op==TK_ID) {
							...
							/* Use the original text of the column expression as its name */zName=sqlite3MPrintf(db,"%s",pEList.a[i].zSpan);
						}
				}
				//if ( db.mallocFailed != 0 )
				//{
        ...
        */nName=StringExtensions.sqlite3Strlen30(zName);
		...
		///
		///</summary>
		static void selectAddColumnTypeAndCollation(Parse pParse,/* Parsing contexts */int nCol,/* Number of columns */Column[] aCol,/* List of columns */Select pSelect/* SELECT used to determine types and collations */) {
			sqlite3 db=pParse.db;
			NameContext sNC;
			Column pCol;
			CollSeq pColl;
      ...
      ** is disabled */Debug.Assert(db.lookaside.bEnabled==0);
			pTab.nRef=1;
			pTab.zName=null;
      ...
      */sqlite3ExprCacheClear(pParse);
			...
			if(p.pLimit!=null) {
				...
				if(NEVER(v==null))
					return;
				/* VDBE should have already been allocated */if(sqlite3ExprIsInteger(p.pLimit,ref n)!=0) {
...
*/static CollSeq multiSelectCollSeq(Parse pParse,Select p,int iCol) {
		...
		///</summary>
		static int multiSelect(Parse pParse,/* Parsing context */Select p,/* The right-most of SELECTs to be coded */SelectDest pDest/* What to do with query results */) {
			int rc=SQLITE_OK;
			/* Success code from a subroutine */Select pPrior;
			/* Another SELECT immediately to our left */Vdbe v;
			/* Generate code to this VDBE */SelectDest dest=new SelectDest();
			/* Alternative data destination */Select pDelete=null;
			/* Chain of simple selects to delete */sqlite3 db;
			/* Database connection */
			#if !SQLITE_OMIT_EXPLAIN
			int iSub1=0;
			/* EQP id of left-hand query */int iSub2=0;
			/* EQP id of right-hand query */
			#endif
			/* Make sure there is no ORDER BY or LIMIT clause on prior SELECTs.  Only
** the last (right-most) SELECT in the series may have an ORDER BY or LIMIT.
*/Debug.Assert(p!=null&&p.pPrior!=null);
			/* Calling function guarantees this much */db=pParse.db;
			pPrior=p.pPrior;
			...
			v=sqlite3GetVdbe(pParse);
			Debug.Assert(v!=null);
			/* The VDBE already created by calling function *//* Create the destination temporary table if necessary
      ...
      */switch(p.tk_op) {
			case TK_ALL: {
				...
				if(pPrior.pLimit!=null&&sqlite3ExprIsInteger(pPrior.pLimit,ref nLimit)!=0&&p.nSelectRow>(double)nLimit) {
			...
			case TK_UNION: {
				int unionTab;
				/* VdbeCursor number of the temporary table holding result */SelectResultType op=0;
				/* One of the SelectResultType. operations to apply to self */SelectResultType priorOp;
				/* The SelectResultType. operation to apply to prior selects */Expr pLimit,pOffset;
				/* Saved values of p.nLimit and p.nOffset */int addr;
...
** of a 3-way or more compound */Debug.Assert(p.pLimit==null);
					/* Not allowed on leftward elements */Debug.Assert(p.pOffset==null);
					/* Not allowed on leftward elements */unionTab=dest.iParm;
				}
				else {
            ...
            ** Be sure to delete p.pOrderBy, therefore, to avoid a memory leak. */sqlite3ExprListDelete(db,ref p.pOrderBy);
				pDelete=p.pPrior;
				p.pPrior=pPrior;
				p.pOrderBy=null;
				if(p.tk_op==TK_UNION)
      ...
      */if((p.selFlags&SelectFlags.UsesEphemeral)!=0) {
				int i;
				/* Loop counter */KeyInfo pKeyInfo;
				/* Collating sequence for the result set */Select pLoop;
				/* For looping through SELECT statements */CollSeq apColl;
				/* For looping through pKeyInfo.aColl[] */int nCol;
				/* Number of columns in result set */Debug.Assert(p.pRightmost==p);
				nCol=p.pEList.nExpr;
              ...
              ** always safely abort as soon as the first unused slot is found */Debug.Assert(pLoop.addrOpenEphm[1]<0);
							break;
						}
...
** iBreak.
*/static int generateOutputSubroutine(Parse pParse,/* Parsing context */Select p,/* The SELECT statement */SelectDest pIn,/* Coroutine supplying data */SelectDest pDest,/* Where to send the data */int regReturn,/* The return address register */int regPrev,/* Previous result register.  No uniqueness if 0 */KeyInfo pKeyInfo,/* For comparing with previous entry */int p4type,/* The p4 type for pKeyInfo */int iBreak/* Jump here if we hit the LIMIT */) {
			Vdbe v=pParse.pVdbe;
			int iContinue;
			int addr;
      ...
      */if(regPrev!=0) {
				...
				j2=sqlite3VdbeAddOp4(v,OP_Compare,pIn.iMem,regPrev+1,pIn.nMem,pKeyInfo,p4type);
...
*/case SelectResultType.Set: {
				...
				p.affinity=sqlite3CompareAffinity(p.pEList.a[0].pExpr,pDest.affinity);
				r1=sqlite3GetTempReg(pParse);
...
*/case SelectResultType.Mem: {
				...
				/* The LIMIT clause will jump out of the loop for us */break;
			}
			#endif
...
*/case SelectResultType.Coroutine: {
      ...
      */sqlite3VdbeResolveLabel(v,iContinue);
		...
		static int multiSelectOrderBy(Parse pParse,/* Parsing context */Select p,/* The right-most of SELECTs to be coded */SelectDest pDest/* What to do with query results */) {
			int i,j;
			/* Loop counters */Select pPrior;
			/* Another SELECT immediately to our left */Vdbe v;
			/* Generate code to this VDBE */SelectDest destA=new SelectDest();
			/* Destination for coroutine A */SelectDest destB=new SelectDest();
			/* Destination for coroutine B */int regAddrA;
			/* Address register for select-A coroutine */int regEofA;
			/* Flag to indicate when select-A is complete */int regAddrB;
			/* Address register for select-B coroutine */int regEofB;
			/* Flag to indicate when select-B is complete */int addrSelectA;
			/* Address of the select-A coroutine */int addrSelectB;
			/* Address of the select-B coroutine */int regOutA;
			/* Address register for the output-A subroutine */int regOutB;
			/* Address register for the output-B subroutine */int addrOutA;
			/* Address of the output-A subroutine */int addrOutB=0;
			/* Address of the output-B subroutine */int addrEofA;
			/* Address of the select-A-exhausted subroutine */int addrEofB;
			/* Address of the select-B-exhausted subroutine */int addrAltB;
			/* Address of the A<B subroutine */int addrAeqB;
			/* Address of the A==B subroutine */int addrAgtB;
			/* Address of the A>B subroutine */int regLimitA;
			/* Limit register for select-A */int regLimitB;
			/* Limit register for select-A */int regPrev;
			/* A range of registers to hold previous output */int savedLimit;
			/* Saved value of p.iLimit */int savedOffset;
			/* Saved value of p.iOffset */int labelCmpr;
			/* Label for the start of the merge algorithm */int labelEnd;
			/* Label for the end of the overall SELECT stmt */int j1;
			/* Jump instructions that get retargetted */int op;
			/* One of TK_ALL, TK_UNION, TK_EXCEPT, TK_INTERSECT */KeyInfo pKeyDup=null;
			/* Comparison information for duplicate removal */KeyInfo pKeyMerge;
			/* Comparison information for merging rows */sqlite3 db;
			/* Database connection */ExprList pOrderBy;
			/* The ORDER BY clause */int nOrderBy;
			/* Number of terms in the ORDER BY clause */int[] aPermute;
			...
			/* "Managed" code needs this.  Ticket #3382. */db=pParse.db;
			v=pParse.pVdbe;
			Debug.Assert(v!=null);
			/* Already thrown the error if VDBE alloc failed */labelEnd=sqlite3VdbeMakeLabel(v);
      ...
      */p.pPrior=null;
			...
			/* Compute the limit registers */computeLimitRegisters(pParse,p,labelEnd);
			if(p.iLimit!=0&&op==TK_ALL) {
				regLimitA=++pParse.nMem;
				regLimitB=++pParse.nMem;
				sqlite3VdbeAddOp2(v,OP_Copy,(p.iOffset!=0)?p.iOffset+1:p.iLimit,regLimitA);
      ...
      */sqlite3VdbeResolveLabel(v,labelCmpr);
			...
			sqlite3VdbeAddOp4(v,OP_Compare,destA.iMem,destB.iMem,nOrderBy,pKeyMerge,P4_KEYINFO_HANDOFF);
      ...
      ** by the calling function */if(p.pPrior!=null) {
				sqlite3SelectDelete(db,ref p.pPrior);
			}
			p.pPrior=pPrior;
			/*** TBD:  Insert subroutine calls to close cursors on incomplete
      **** subqueries ****/explainComposite(pParse,p.tk_op,iSub1,iSub2,false);
			return SQLITE_OK;
		}
		#endif
		...
		///
		///</summary>
		static Expr substExpr(sqlite3 db,/* Report malloc errors to this connection */Expr pExpr,/* Expr in which substitution occurs */int iTable,/* Table to be substituted */ExprList pEList/* Substitute expressions */) {
			if(pExpr==null)
				return null;
		...
		static void substExprList(sqlite3 db,/* Report malloc errors here */ExprList pList,/* List to scan and in which to make substitutes */int iTable,/* Table to be substituted */ExprList pEList/* Substitute values */) {
			int i;
			if(pList==null)
				return;
		...
		static void substSelect(sqlite3 db,/* Report malloc errors here */Select p,/* SELECT statement in which to make substitutions */int iTable,/* Table to be replaced */ExprList pEList/* Substitute values */) {
			SrcList pSrc;
			SrcList_item pItem;
			int i;
			if(p==null)
			...
			/* Even for (SELECT 1) we have: pSrc!=0 but pSrc->nSrc==0 */if(ALWAYS(pSrc)) {
		...
		///</summary>
		static int flattenSubquery(Parse pParse,/* Parsing context */Select p,/* The parent or outer SELECT statement */int iFrom,/* Index in p.pSrc.a[] of the inner subquery */bool isAgg,/* True if outer SELECT uses aggregate functions */bool subqueryIsAgg/* True if the subquery uses aggregate functions */) {
			string zSavedAuthContext=pParse.zAuthContext;
			Select pParent;
			Select pSub;
			/* The inner query or "subquery" */Select pSub1;
			/* Pointer to the rightmost select in sub-query */SrcList pSrc;
			/* The FROM clause of the outer query */SrcList pSubSrc;
			/* The FROM clause of the subquery */ExprList pList;
			/* The result set of the outer query */int iParent;
			/* VDBE cursor number of the pSub result set temp table */int i;
			/* Loop counter */Expr pWhere;
			/* The WHERE clause */SrcList_item pSubitem;
			/* The subquery */sqlite3 db=pParse.db;
			/* Check to see if flattening is permitted.  Return 0 if not.
      */Debug.Assert(p!=null);
			Debug.Assert(p.pPrior==null);
			/* Unable to flatten compound queries */if((db.flags&SQLITE_QueryFlattener)!=0)
				return 0;
			pSrc=p.pSrc;
			...
			if(isAgg&&subqueryIsAgg)
				return 0;
			/* Restriction (1)  */if(subqueryIsAgg&&pSrc.nSrc>1)
				return 0;
			/* Restriction (2)  */pSubSrc=pSub.pSrc;
			Debug.Assert(pSubSrc!=null);
			/* Prior to version 3.1.2, when LIMIT and OFFSET had to be simple constants,
      ** not arbitrary expresssions, we allowed some combining of LIMIT and OFFSET
      ** because they could be computed at compile-time.  But when LIMIT and OFFSET
      ** became arbitrary expressions, we were forced to add restrictions (13)
      ** and (14). */if(pSub.pLimit!=null&&p.pLimit!=null)
				return 0;
			/* Restriction (13) */if(pSub.pOffset!=null)
				return 0;
			/* Restriction (14) */if(p.pRightmost!=null&&pSub.pLimit!=null) {
				return 0;
				/* Restriction (15) */}
			if(pSubSrc.nSrc==0)
				return 0;
			/* Restriction (7)  */if((pSub.selFlags&SelectFlags.Distinct)!=0)
				return 0;
			/* Restriction (5)  */if(pSub.pLimit!=null&&(pSrc.nSrc>1||isAgg)) {
				return 0;
				/* Restrictions (8)(9) */}
			...
			if(isAgg&&pSub.pOrderBy!=null)
				return 0;
			/* Restriction (16) */if(pSub.pLimit!=null&&p.pWhere!=null)
				return 0;
			/* Restriction (19) */if(pSub.pLimit!=null&&(p.selFlags&SelectFlags.Distinct)!=0) {
				return 0;
				/* Restriction (21) */}
			/* OBSOLETE COMMENT 1:
      ...
      */if(pSub.pPrior!=null) {
				...
				/* Restriction 18. */if(p.pOrderBy!=null) {
					int ii;
			...
			/***** If we reach this point, flattening is permitted. *****//* Authorize the subquery */pParse.zAuthContext=pSubitem.zName;
      ...
      */for(pParent=p;pParent!=null;pParent=pParent.pPrior,pSub=pSub.pPrior) {
				...
				u8 jointype=0;
				pSubSrc=pSub.pSrc;
				/* FROM clause of subquery */nSubSrc=pSubSrc.nSrc;
				/* Number of terms in subquery FROM clause */pSrc=pParent.pSrc;
				/* FROM clause of the outer query */if(pSrc!=null) {
					Debug.Assert(pParent==p);
					/* First time through the loop */jointype=pSubitem.jointype;
				}
				else {
					Debug.Assert(pParent!=p);
					/* 2nd and subsequent times through the loop */pSrc=pParent.pSrc=sqlite3SrcListAppend(db,null,null,null);
					//if ( pSrc == null )
					//{
					//  //Debug.Assert( db.mallocFailed != 0 );
					//  break;
      ...
      */for(i=0;i<pTabList.nSrc;i++)// pFrom++ )
          ...
          ** to go further. */Debug.Assert(i==0);
					return WRC_Prune;
				}
				if(pFrom.zName==null) {
					#if !SQLITE_OMIT_SUBQUERY
					Select pSel=pFrom.pSelect;
					/* A sub-query in the FROM clause of a SELECT */Debug.Assert(pSel!=null);
					...
					/* An ordinary table or view name in the FROM clause */Debug.Assert(pFrom.pTab==null);
					...
					if(pTab.pSelect!=null||IsVirtual(pTab)) {
						/* We reach here if the named table is a really a view */if(sqlite3ViewGetColumnNames(pParse,pTab)!=0)
							return WRC_Abort;
				...
				/* Locate the index named by the INDEXED BY clause, if any. */if(sqlite3IndexedByLookup(pParse,pFrom)!=0) {
					return WRC_Abort;
				}
			}
      ...
      */for(k=0;k<pEList.nExpr;k++) {
        ...
        */ExprList_item[] a=pEList.a;
            ...
            ** expanded. */int tableSeen=0;
						/* Set to 1 when TABLE matches */string zTName;
						/* text of name of TABLE */if(pE.op==TK_DOT) {
						...
						for(i=0;i<pTabList.nSrc;i++)//, pFrom++ )
						 {
							...
							for(j=0;j<pTab.nCol;j++) {
								...
								string zColname;
								/* The computed column name */string zToFree;
								/* Malloced string that needs to be freed */Token sColname=new Token();
								/* Computed column name as a token *//* If a column is marked as 'hidden' (currently only possible
                ...
                */if(IsHiddenColumn(pTab.aCol[j])) {
                    ...
                    ** table to the right of the join */continue;
									}
									if(sqlite3IdListIndex(pFrom.pUsing,zName)>=0) {
										/* In a join with a USING clause, omit columns in the
                    ** using clause from the table on the right. */continue;
									}
								}
				...
				for(i=0;i<pTabList.nSrc;i++)//, pFrom++ )
				 {
					...
					if(ALWAYS(pTab!=null)&&(pTab.tabFlags&TF_Ephemeral)!=0) {
						/* A sub-query in the FROM clause of a SELECT */Select pSel=pFrom.pSelect;
		...
		///
		///</summary>
		static void sqlite3SelectPrep(Parse pParse,/* The parser context */Select p,/* The SELECT statement being coded. */NameContext pOuterNC/* Name context for container */) {
			sqlite3 db;
			if(NEVER(p==null))
				return;
			db=pParse.db;
			...
			for(i=0;i<pAggInfo.nFunc;i++) {
				...
				if(pFunc.iDistinct>=0) {
					...
					if(pE.x.pList==null||pE.x.pList.nExpr!=1) {
						...
						sqlite3VdbeAddOp4(v,OP_OpenEphemeral,pFunc.iDistinct,0,0,pKeyInfo,P4_KEYINFO_HANDOFF);
					}
				}
			}
		}
		...
		static void finalizeAggFunctions(Parse pParse,AggInfo pAggInfo) {
			...
			for(i=0;i<pAggInfo.nFunc;i++) {
				...
				sqlite3VdbeAddOp4(v,OP_AggFinal,pF.iMem,pList!=null?pList.nExpr:0,0,pF.pFunc,P4_FUNCDEF);
			}
		}
		/*
    ...
    */static void updateAccumulator(Parse pParse,AggInfo pAggInfo) {
			...
			for(i=0;i<pAggInfo.nFunc;i++) {
				...
				if((pF.pFunc.flags&SQLITE_FUNC_NEEDCOLL)!=0) {
					...
					/* pList!=0 if pF->pFunc has NEEDCOLL */for(j=0;pColl==null&&j<nArg;j++) {
						//, pItem++){
						pItem=pList.a[j];
						pColl=sqlite3ExprCollSeq(pParse,pItem.pExpr);
					}
				...
				sqlite3VdbeAddOp4(v,OP_AggStep,0,regAgg,pF.iMem,pF.pFunc,P4_FUNCDEF);
      ...
      */sqlite3ExprCacheClear(pParse);
		...
		///</summary>
		#if !SQLITE_OMIT_EXPLAIN
		static void explainSimpleCount(Parse pParse,/* Parse context */Table pTab,/* Table being queried */Index pIdx/* Index used to optimize scan, or NULL */) {
			if(pParse.explain==2) {
				string zEqp=sqlite3MPrintf(pParse.db,"SCAN TABLE %s %s%s(~%d rows)",pTab.zName,pIdx!=null?"USING COVERING INDEX ":"",pIdx!=null?pIdx.zName:"",pTab.nRowEst);
				sqlite3VdbeAddOp4(pParse.pVdbe,OP_Explain,pParse.iSelectId,0,0,zEqp,P4_DYNAMIC);
			}
		}
		#else
    ...
    static void explainSimpleCount(Parse a, Table b, Index c){}
		...
		static int sqlite3Select(Parse pParse,/* The parser context */Select p,/* The SELECT statement being coded. */ref SelectDest pDest/* What to do with the query results */) {
			int i,j;
			/* Loop counters */WhereInfo pWInfo;
			/* Return from sqlite3WhereBegin() */Vdbe v;
			/* The virtual machine under construction */bool isAgg;
			/* True for select lists like "count()" */ExprList pEList=new ExprList();
			/* List of columns to extract. */SrcList pTabList=new SrcList();
			/* List of tables to select from */Expr pWhere;
			/* The WHERE clause.  May be NULL */ExprList pOrderBy;
			/* The ORDER BY clause.  May be NULL */ExprList pGroupBy;
			/* The GROUP BY clause.  May be NULL */Expr pHaving;
			/* The HAVING clause.  May be NULL */bool isDistinct;
			/* True if the DISTINCT keyword is present */int distinct;
			/* Table to use for the distinct set */int rc=1;
			/* Value to return from this function */int addrSortIndex;
			/* Address of an OP_OpenEphemeral instruction */AggInfo sAggInfo;
			/* Information used by aggregate queries */int iEnd;
			/* Address of the end of the query */sqlite3 db;
        ...
        ** DISTINCT so it can be removed too. */sqlite3ExprListDelete(db,ref p.pOrderBy);
				p.pOrderBy=null;
...
*/
        ...
        */pParse.nHeight+=sqlite3SelectExprHeight(p);
				/* Check to see if the subquery can be absorbed into the parent. */isAggSub=(pSub.selFlags&SelectFlags.Aggregate)!=0;
...
*/Debug.Assert(p.pGroupBy==null||(p.selFlags&SelectFlags.Aggregate)!=0);
      ...
      */if(pOrderBy!=null) {
				...
				p.addrOpenEphm[2]=addrSortIndex=sqlite3VdbeAddOp4(v,OP_OpenEphemeral,pOrderBy.iECursor,pOrderBy.nExpr+2,0,pKeyInfo,P4_KEYINFO_HANDOFF);
			}
			else {
				addrSortIndex=-1;
			}
      ...
      */if((p.selFlags&SelectFlags.Distinct)!=0) {
				...
				sqlite3VdbeAddOp4(v,OP_OpenEphemeral,distinct,0,0,pKeyInfo,P4_KEYINFO_HANDOFF);
				sqlite3VdbeChangeP5(v,BTREE_UNORDERED);
			}
			else {
				distinct=-1;
			}
			/* Aggregate and non-aggregate queries are handled differently */if(!isAgg&&pGroupBy==null) {
        ...
        */sqlite3WhereEnd(pWInfo);
				...
				/* Name context for processing aggregate information */int iAMem;
				/* First Mem address for storing current GROUP BY */int iBMem;
				/* First Mem address for previous GROUP BY */int iUseFlag;
				/* Mem address holding flag indicating that at least
** one row of the input to the aggregator has been
** processed */int iAbortFlag;
				/* Mem address which causes query abort if positive */int groupBySort;
				/* Rows come from source in GR BY' clause thanROUP BY order */int addrEnd;
				/* End of processing for this SELECT *//* Remove any and all aliases between the result set and the
        ** GROUP BY clause.
        */if(pGroupBy!=null) {
					int k;
					/* Loop counter */ExprList_item pItem;
					/* For looping over expression in a list */for(k=p.pEList.nExpr;k>0;k--)//, pItem++)
					 {
				...
				/* Create a label to jump to when we want to abort the query */addrEnd=sqlite3VdbeMakeLabel(v);
        ...
        */if(pGroupBy!=null) {
					KeyInfo pKeyInfo;
					/* Keying information for the group by clause */int j1;
					/* A-vs-B comparision jump */int addrOutputRow;
					/* Start of subroutine that outputs a result row */int regOutputRow;
					/* Return address register for output subroutine */int addrSetAbort;
					/* Set the abort flag and return */int addrTopOfLoop;
					/* Top of the input loop */int addrSortingIdx;
					/* The OP_OpenEphemeral for the sorting index */int addrReset;
					/* Subroutine for resetting the accumulator */int regReset;
					/* Return address register for reset subroutine *//* If there is a GROUP BY clause we might need a sorting index to
          ** implement it.  Allocate that sorting index now.  If it turns out
          ** that we do not need it after all, the OpenEphemeral instruction
          ** will be converted into a Noop.
          */sAggInfo.sortingIdx=pParse.nTab++;
					pKeyInfo=keyInfoFromExprList(pParse,pGroupBy);
					addrSortingIdx=sqlite3VdbeAddOp4(v,OP_OpenEphemeral,sAggInfo.sortingIdx,sAggInfo.nSortingColumn,0,pKeyInfo,P4_KEYINFO_HANDOFF);
...
*/sqlite3VdbeAddOp2(v,OP_Gosub,regReset,addrReset);
            ...
            */int regBase;
						...
						for(i=0;i<sAggInfo.nColumn;i++) {
							...
							if(pCol.iSorterColumn>=j) {
								int r1=j+regBase;
								int r2;
								r2=sqlite3ExprCodeGetColumn(pParse,pCol.pTab,pCol.iColumn,pCol.iTable,r1);
								if(r1!=r2) {
          ...
          */addrTopOfLoop=sqlite3VdbeCurrentAddr(v);
					...
					sqlite3VdbeAddOp4(v,OP_Compare,iAMem,iBMem,pGroupBy.nExpr,pKeyInfo,P4_KEYINFO);
...
*/sqlite3VdbeAddOp2(v,OP_Goto,0,addrEnd);
          ...
          */sqlite3VdbeResolveLabel(v,addrReset);
				...
				/* endif pGroupBy.  Begin aggregate queries without GROUP BY: */else {
					ExprList pDel=null;
            ...
            */int iDb=sqlite3SchemaToIndex(pParse.db,pTab.pSchema);
						...
						/* Cursor to scan b-tree */Index pIdx;
						/* Iterator variable */KeyInfo pKeyInfo=null;
						/* Keyinfo for scanned index */Index pBest=null;
						/* Best index found so far */int iRoot=pTab.tnum;
						/* Root page of scanned b-tree */sqlite3CodeVerifySchema(pParse,iDb);
            ...
            */for(pIdx=pTab.pIndex;pIdx!=null;pIdx=pIdx.pNext) {
						...
						/* Open a read-only cursor, execute the OP_Count, close the cursor. */sqlite3VdbeAddOp3(v,OP_OpenRead,iCsr,iRoot,iDb);
						if(pKeyInfo!=null) {
            ...
            */resetAccumulator(pParse,sAggInfo);
			...
			/* endif aggregate query */if(distinct>=0) {
