...
namespace Community.CsharpSqlite
{
    ...
    public class RowSet
    {
        ...
        ///
        ///</summary>
        public void sqlite3RowSetClear()
        {
            RowSet p = this;
        ...
        ///
        ///</summary>
        public void sqlite3RowSetInsert(i64 rowid)
        {
            RowSet p = this;
            ...
            if (p.nFresh == 0)
            {
                ...
                p.nFresh = Sqlite3.ROWSET_ENTRY_PER_CHUNK;
            }
        ...
        ///
        ///</summary>
        public static RowSetEntry rowSetMerge(RowSetEntry pA, ///
            ///<summary>
        ...
        public void rowSetToList()
        {
            ...
            if (p.pTree != null)
            {
                ...
                p.pTree.rowSetTreeToList(ref pHead, ref pTail);
                p.pTree = null;
        ...
        ///
        ///</summary>
        public int sqlite3RowSetNext(ref i64 pRowid)
        {
            RowSet p = this;
            p.rowSetToList();
            if (p.pEntry != null)
        ...
        public int sqlite3RowSetTest(u8 iBatch, sqlite3_int64 iRowid)
        {
            RowSet pRowSet = this;
            RowSetEntry p;
            if (iBatch != pRowSet.iBatch)
            {
                ...
                {
                    pRowSet.rowSetToList();
                    pRowSet.pTree = pRowSet.pEntry.rowSetListToTree();
                    pRowSet.pEntry = null;
                    pRowSet.pLast = null;
                }
