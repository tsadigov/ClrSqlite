...
namespace Community.CsharpSqlite {
    ...
    *///#define ROWSET_ALLOCATION_SIZE 1024
		...
		public class RowSetEntry {
			public i64 v;
			/* ROWID value for this entry */public RowSetEntry pRight;
			/* Right subtree (larger entries) or list */public RowSetEntry pLeft;
		...
		public class RowSetChunk {
			...
			/* Next chunk on list of them all */public RowSetEntry[] aEntry=new RowSetEntry[ROWSET_ENTRY_PER_CHUNK];
		/* Allocated entries */};
		...
		public class RowSet {
			...
			/* List of all chunk allocations */public sqlite3 db;
			/* The database connection */public RowSetEntry pEntry;
			/* /* List of entries using pRight */public RowSetEntry pLast;
			/* Last entry on the pEntry list */public RowSetEntry[] pFresh;
			/* Source of new entry objects */public RowSetEntry pTree;
			/* Binary tree of entries */public int nFresh;
			/* Number of objects on pFresh */public bool isSorted;
			/* True if pEntry is sorted */public u8 iBatch;
			/* Current insert batch */public RowSet(sqlite3 db,int N) {
				this.pChunk=null;
				this.db=db;
				this.pEntry=null;
				this.pLast=null;
		...
		static void sqlite3RowSetInsert(RowSet p,i64 rowid) {
			RowSetEntry pEntry;
			/* The new entry */RowSetEntry pLast;
			/* The last prior entry */Debug.Assert(p!=null);
			if(p.nFresh==0) {
				RowSetChunk pNew;
			...
			if(pLast!=null) {
				...
				/* Fires if INSERT after SMALLEST */p.pEntry=pEntry;
			}
			p.pLast=pEntry;
		}
		///<summary>
		...
		///
		///</summary>
		static RowSetEntry rowSetMerge(RowSetEntry pA,/* First sorted list to be merged */RowSetEntry pB/* Second sorted list to be merged */) {
		...
		///
		///</summary>
		static void rowSetTreeToList(RowSetEntry pIn,/* Root of the input tree */ref RowSetEntry ppFirst,/* Write head of the output list here */ref RowSetEntry ppLast/* Write tail of the output list here */) {
		...
		static RowSetEntry rowSetNDeepTree(ref RowSetEntry ppList,int iDepth) {
			RowSetEntry p;
			/* Root of the new tree */RowSetEntry pLeft;
			/* Left subtree */if(ppList==null) {
				return null;
			}
			if(iDepth==1) {
				p=ppList;
		...
		static RowSetEntry rowSetListToTree(RowSetEntry pList) {
			int iDepth;
			/* Depth of the tree so far */RowSetEntry p;
			/* Current tree root */RowSetEntry pLeft;
			/* Left subtree */Debug.Assert(pList!=null);
			p=pList;
			pList=p.pRight;
			p.pLeft=p.pRight=null;
