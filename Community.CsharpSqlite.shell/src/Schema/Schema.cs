    ...
    public class Schema
        {
            ...
            ///</summary>
            public Hash<Table> Tables = new Hash<Table>();
            ///
            ///<summary>
            ///All (named) indices indexed by name 
            ///</summary>
            public Hash<Index> Indexes = new Hash<Index>();
            ///
            ///<summary>
            ///All triggers indexed by name 
            ///</summary>
            public Hash<Trigger> Triggers = new Hash<Trigger>();
            ///
            ///<summary>
            ///All foreign keys by referenced table name 
            ///</summary>
            public Hash<FKey> ForeignKeys = new Hash<FKey>();
            ///
            ///<summary>
            ...
            public void Clear()
            {
                ...
                {
                    schema_cookie = 0;
                    Tables = new Hash<Table>();
                    Indexes = new Hash<Index>();
                    Triggers = new Hash<Trigger>();
                    ForeignKeys = new Hash<FKey>();
                    pSeqTab = null;
                }
            }
        ...
        {
            Tables.sqlite3HashInit();
            Indexes.sqlite3HashInit();
            Triggers.sqlite3HashInit();
            ForeignKeys.sqlite3HashInit();
        }
    };
