...
int origPc;                  /* Program counter at start of opcode */
      ...
      sqlite3EndBenignMalloc();
                    ...
                    var handlers = new List<Func<CPU, OpCode, VdbeOp, RuntimeException>>() { 
                            _OpCode.Exec,
                                ...
                                case OpCode.OP_SetCookie:
                                    {
                                        ...
                                        Debug.Assert(Sqlite3.sqlite3SchemaMutexHeld(db, pOp.p1, null));
                                        pIn3 = aMem[pOp.p3];
...
#endif
#endif
                                        this.aCounter[Sqlite3.SQLITE_STMTSTATUS_SORT - 1]++;
                                        ///
                                        ///<summary>
                                ...
                                case OpCode.OP_Clear:
                                    {
                                        ...
                                        if (pOp.p3 != 0)
                                        {
                                            ...
                                            if (pOp.p3 > 0)
                                            {
                                                ...
                                                this.memAboutToChange(aMem[pOp.p3]);
                ...
                Debug.Assert( iDb == 1 || sqlite3BtreeHoldsMutex( db.aDb[iDb].pBt ) );
                                        ...
                                        ///</summary>
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                rc = legacy.sqlite3_exec(db, zSql, (dxCallback)Sqlite3.sqlite3InitCallback, (object)initData, 0);
                                                if (rc == SqlResult.SQLITE_OK)
                                                    rc = initData.rc;
                                ...
                                case OpCode.OP_LoadAnalysis:
                                    {
                                        Debug.Assert(pOp.p1 >= 0 && pOp.p1 < db.nDb);
                                        rc = Sqlite3.sqlite3AnalysisLoad(db, pOp.p1);
                                        break;
                                    }
#endif
...
rc = sqlite3BtreeSetVersion(pBt, (eNew==PAGER_JOURNALMODE_WAL ? 2 : 1));
                                        ...
                                        pOut.z = Sqlite3.sqlite3JournalModename(eNew);
                                ...
                                case OpCode.OP_Trace:
                                    {
                                        ...
                                        {
                                            z = Sqlite3.sqlite3VdbeExpandSql(this, zTrace);
