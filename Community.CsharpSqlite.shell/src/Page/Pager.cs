                ...
                void pager_unlock()
                {
                    ...
                    if (this.pagerUseWal())
                    {
                        ...
                        if (!this.exclusiveMode)
                        {
                            ...
                            int iDc = this.fd.isOpen   ? sqlite3OsDeviceCharacteristics(this.fd) : 0;
                            ///
                            ///<summary>
